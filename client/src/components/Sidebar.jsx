...
const Sidebar = ({ openHamburger, handleAddBoard, createdBoards }) => {
  ...
  return (
    <aside
      ...
      } bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-sky-800 dark:border-gray-700`}
      aria-label="Sidebar"
    >
      <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-sky-800">
